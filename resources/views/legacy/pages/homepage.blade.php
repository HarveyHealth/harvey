...
<div class="sections check-load" :class="{'is-loaded': appLoaded}">
    ...
    <section class="section">
        <div class="container has-text-centered">
            ...
            <p class="copy-has-max-width subtitle is-4-desktop is-5-mobile">Harvey's doctors take a preventative and relationship-driven approach to medicine, with an emphasis on nutrition, lifestyle and enviromnent, to help you find the root cause of chronic health conditions and reduce risk of serious disease.</p>
            <div class="button-wrapper">
