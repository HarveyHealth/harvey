            ...
            <div class="flex-ns flex-wrap-ns pt4 pb5-l pb3">
                ...
                <div class="w-100 w-50-ns tc">
                    <div class="ph5-l ph3 mb4">
                      ...
                      <p class="f4-l f5">Harvey doctors take whole-body, root-cause approach to medicine. We view the body as one integrated system, not a collection of organs.</p>
                    </div>
                </div>
                <div class="w-100 w-50-ns tc">
                    <div class="ph5-l ph3 mb4">
                ...
                <div class="w-100 w-50-ns tc">
                    <div class="ph5-l ph3 mb4">
                      ...
                      <p class="f4-l f5">Our natural treatment plans may include vitamins, supplements, or diet and lifestyle changes. We will never prescribe pharmaceuticals.</p>
                    </div>
                </div>
                <div class="w-100 w-50-ns tc">
                    <div class="ph5-l ph3 mb4">
                      ...
                      <p class="f4-l f5">Manage all your appointments, lab results, supplement prescriptions and treatment plans from one central dashboard.</p>
                    </div>
                </div>
                <div class="w-100 w-50-ns tc">
                    <div class="ph5-l ph3 mb4">
    ...
    <section id="get-started" class="bg-near-white">
        <div class="container">
            <div class="ph6-l ph4-m ph3 pv5 tc">
                <p class="f2-l f3">Start your health journey.</p>
