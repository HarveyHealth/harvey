    ...
    <section class="section" id="symptoms">
        <div class="section-wrapper">
            <div class="container content">
                ...
                <p class="copy-has-max-width subtitle is-5 has-text-centered">Our doctors have had success treating a variety of symptoms and conditions. To get started, tell us the severity of your problem areas using the sliders below (5 being most severe).</p>
