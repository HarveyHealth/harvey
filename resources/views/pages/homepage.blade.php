    ...
    <section class="section" id="symptoms">
        <div class="section-wrapper">
            <div class="container content">
                ...
                <p class="copy-has-max-width subtitle is-5 has-text-centered">Our doctors have had success treating a variety of different body system conditions. To get started, tell us the severity of each of your symptoms using the sliders below (5 is the most severe).</p>
