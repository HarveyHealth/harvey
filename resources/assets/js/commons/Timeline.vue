<template>
    <div>
        <div v-for="item in items" style="height: 80px;">
            <div @click="item.onClick" style="background-color: #d8d8d8; border-radius: 50%; width: 25px; height: 25px; float: left; margin: 5% 15px 5% 0; cursor: pointer;" />
