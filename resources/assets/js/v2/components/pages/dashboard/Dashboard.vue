...
export default {
  name: 'dashboard',
  components: { AppointmentCardInfo, AvatarCardHeading, Card, CardContent, Grid, LabeledTextBlock, LoadingSpinner, PageHeader, PageContainer, Paragraph, SlideIn, Spacer, NotificationPopup },
  data() {
    return {
  ...
  mounted() {
    ...
    if (Laravel.app.message !== undefined) {
