  ...
  <div id="footer">
    ...
    <div class="tc ph4 pv5 nav-links">
      ...
      <div class="mt4 nav-links">
        ...
        <a href="/lab-tests" class="dim pa1 fw4">Labs</a>
        <a href="/#conditions" class="dim pa1 fw4">Conditions</a><br class="d dn-l"/>
        <a href="/financing" class="dim pa1 fw4">Financing</a>
        <a href="/blog" class="dim pa1 fw4">Blog</a>
        <a href="http://help.goharvey.com" class="dim pa1 fw4">Help</a>
      </div>
      <div class="mt4 w-100 w-60-ns margin-0a">
        <p class="font-sm copyright fw4">
