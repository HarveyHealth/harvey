<template>
  <div :class="containerClasses" v-if="!$root.$data.signup.completedSignup">
    ...
    <div class="signup-container signup-stage-container signup-schedule-container">
      <router-link class="signup-back-button" :to="{ name: this.prevStage.name, path: '/' + this.prevStage.name }"><i class="fa fa-long-arrow-left"></i> {{ this.prevStage.display }}</router-link>
