! function (t, e) {
    ...
    function r(t, e, n) {
        ...
        if ("string" == typeof e) {
            if (ke.test(e)) return fe.filter(e, t, n);
            e = fe.filter(e, t)
        }
    ...
    function y(t, e, n, r, i) {
        ...
        for (l && y.removeChild(l), pe.appendChecked || fe.grep(d(v, "input"), g), w = 0; o = v[w++];)
            if (r && fe.inArray(o, r) > -1) i && i.push(o);
            else if (a = fe.contains(o.ownerDocument, o), l = d(y.appendChild(o), "script"), a && m(l), n)
    ...
    function A(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            "script" === n && e.text !== t.text ? (k(e).text = t.text, x(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), pe.html5Clone && t.innerHTML && !fe.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && He.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : ("input" === n || "textarea" === n) && (e.defaultValue = t.defaultValue)
        }
    }
    ...
    function C(t, e, n, r) {
        ...
        var i, s, o, a, l, c, u = 0,
            ...
            f = e[0],
            m = fe.isFunction(f);
        if (m || p > 1 && "string" == typeof f && !pe.checkClone && rn.test(f)) return t.each(function (i) {
            var s = t.eq(i);
            m && (e[0] = f.call(this, i, s.html())), C(s, e, n, r)
        });
        if (p && (c = y(e, t[0].ownerDocument, !1, t, r), i = c.firstChild, 1 === c.childNodes.length && (c = i), i || r)) {
            for (a = fe.map(d(c, "script"), k), o = a.length; p > u; u++) s = c, u !== h && (s = fe.clone(s, !0, !0), o && fe.merge(a, d(s, "script"))), n.call(t[u], s, u);
            if (o)
    ...
    function j(t, e, n) {
        for (var r, i = e ? fe.filter(e, t) : t, s = 0; null != (r = i[s]); s++) n || 1 !== r.nodeType || fe.cleanData(d(r)), r.parentNode && (n && fe.contains(r.ownerDocument, r) && m(d(r, "script")), r.parentNode.removeChild(r));
        return t
    }
    ...
    function F(t, e, n) {
        ...
        if (0 >= i || null == i) {
            if (i = gn(t, e, s), (0 > i || null == i) && (i = t.style[e]), hn.test(i)) return i;
    ...
    function q(t, e, n) {
        ...
        for (r in e)
            if (i = e[r], jn.exec(i)) {
                ...
                h[r] = m && m[r] || fe.style(t, r)
            } else c = void 0;
        if (fe.isEmptyObject(h)) "inline" === ("none" === c ? P(t.nodeName) : c) && (f.display = c);
        else {
            m ? "hidden" in m && (d = m.hidden) : m = fe._data(t, "fxshow", {}), s && (m.hidden = !d), d ? fe(t).show() : p.done(function () {
                fe(t).hide()
            }), p.done(function () {
                var e;
    ...
    fe.fn = fe.prototype = {
        ...
        camelCase: function (t) {
            return t.replace(me, "ms-").replace(ge, ye)
        },
    ...
    var ve = function (t) {
        ...
        function v(t) {
            for (var e, n, r, i = t.length, s = _.relative[t[0].type], o = s || _.relative[" "], a = s ? 1 : 0, l = f(function (t) {
                ...
                if (n = _.relative[t[a].type]) u = [f(d(u), n)];
                else {
                    if (n = _.filter[t[a].type].apply(null, t[a].matches), n[N]) {
        ...
        var b, S, _, k, x, T, A, C, j, J, P, $, E, O, M, L, F, D, I, N = "sizzle" + 1 * new Date,
            H = t.document,
            q = 0,
            z = 0,
            R = n(),
        ...
        S = e.support = {}, x = e.isXML = function (t) {
            ...
            return r !== E && 9 === r.nodeType && r.documentElement ? (E = r, O = E.documentElement, M = !x(E), (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", _e, !1) : n.attachEvent && n.attachEvent("onunload", _e)), S.attributes = i(function (t) {
                return t.className = "i", !t.getAttribute("className")
            }), S.getElementsByTagName = i(function (t) {
                return t.appendChild(E.createComment("")), !t.getElementsByTagName("*").length
            }), S.getElementsByClassName = ge.test(E.getElementsByClassName), S.getById = i(function (t) {
                return O.appendChild(t).id = N, !E.getElementsByName || !E.getElementsByName(N).length
            }), S.getById ? (_.find.ID = function (t, e) {
            ...
            }, F = [], L = [], (S.qsa = ge.test(E.querySelectorAll)) && (i(function (t) {
            ...
            })), (S.matchesSelector = ge.test(D = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && i(function (t) {
                S.disconnectedMatch = D.call(t, "div"), D.call(t, "[s!='']:x"), F.push("!=", se)
            }), L = L.length && new RegExp(L.join("|")), F = F.length && new RegExp(F.join("|")), e = ge.test(O.compareDocumentPosition), I = e || ge.test(O.contains) ? function (t, e) {
            ...
            var n = _.attrHandle[e.toLowerCase()],
                r = n && Y.call(_.attrHandle, e.toLowerCase()) ? n(t, e, !M) : void 0;
            ...
            filter: {
                ...
                PSEUDO: function (t, n) {
                    ...
                    return s[N] ? s(n) : s.length > 1 ? (i = [t, t, "", n], _.setFilters.hasOwnProperty(t.toLowerCase()) ? r(function (t, e) {
        ...
        return p.prototype = _.filters = _.pseudos, _.setFilters = new p, T = e.tokenize = function (t, n) {
            ...
            for (a = t, l = [], c = _.preFilter; a;) {
                ...
                for (o in _.filter) !(i = fe[o].exec(a)) || c[o] && !(i = c[o](i)) || (r = i.shift(), s.push({
                    value: r,
                    type: o,
                    matches: i
                }), a = a.slice(r.length));
            ...
            if (n = n || [], 1 === p.length) {
                if (s = p[0] = p[0].slice(0), s.length > 2 && "ID" === (o = s[0]).type && S.getById && 9 === e.nodeType && M && _.relative[s[1].type]) {
                    if (e = (_.find.ID(o.matches[0].replace(be, Se), e) || [])[0], !e) return n;
                    c && (e = e.parentNode), t = t.slice(s.shift().value.length)
                }
                for (i = fe.needsContext.test(t) ? 0 : s.length; i-- && (o = s[i], !_.relative[a = o.type]);)
                    if ((l = _.find[a]) && (r = l(o.matches[0].replace(be, Se), ve.test(s[0].type) && u(e.parentNode) || e))) {
    ...
    var xe, Te = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        Ae = fe.fn.init = function (t, e, n) {
            ...
            if (n = n || xe, "string" == typeof t) {
                ...
                if (r[1]) {
                    if (e = e instanceof fe ? e[0] : e, fe.merge(this, fe.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : re, !0)), _e.test(r[1]) && fe.isPlainObject(e))
    ...
    fe.event = {
        ...
        add: function (t, e, n, r, i) {
            var s, o, a, l, c, u, p, h, f, d, m, g = fe._data(t);
            if (g) {
                for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = fe.guid++), (o = g.events) || (o = g.events = {}), (u = g.handle) || (u = g.handle = function (t) {
                        return "undefined" == typeof fe || t && fe.event.triggered === t.type ? void 0 : fe.event.dispatch.apply(u.elem, arguments)
                    }, u.elem = t), e = (e || "").match(Je) || [""], a = e.length; a--;) s = Ke.exec(e[a]) || [], f = m = s[1], d = (s[2] || "").split(".").sort(), f && (c = fe.event.special[f] || {}, f = (i ? c.delegateType : c.bindType) || f, c = fe.event.special[f] || {}, p = fe.extend({
                    type: f,
                    origType: m,
                    data: r,
                    handler: n,
        ...
        remove: function (t, e, n, r, i) {
            var s, o, a, l, c, u, p, h, f, d, m, g = fe.hasData(t) && fe._data(t);
            if (g && (u = g.events)) {
                for (e = (e || "").match(Je) || [""], c = e.length; c--;)
                    if (a = Ke.exec(e[c]) || [], f = m = a[1], d = (a[2] || "").split(".").sort(), f) {
                        for (p = fe.event.special[f] || {}, f = (r ? p.delegateType : p.bindType) || f, h = u[f] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = s = h.length; s--;) o = h[s], !i && m !== o.origType || n && n.guid !== o.guid || a && !a.test(o.namespace) || r && r !== o.selector && ("**" !== r || !o.selector) || (h.splice(s, 1), o.selector && h.delegateCount--, p.remove && p.remove.call(t, o));
                        l && !h.length && (p.teardown && p.teardown.call(t, d, g.handle) !== !1 || fe.removeEvent(t, f, g.handle), delete u[f])
                    } else
                        for (f in u) fe.event.remove(t, f + e[c], n, r, !0);
                fe.isEmptyObject(u) && (delete g.handle, fe._removeData(t, "events"))
            }
        },
    ...
    t.getComputedStyle ? (mn = function (e) {
        ...
        return n = n || mn(t), o = n ? n.getPropertyValue(e) || n[e] : void 0, "" !== o && void 0 !== o || fe.contains(t.ownerDocument, t) || (o = fe.style(t, e)), n && !pe.pixelMarginRight() && hn.test(o) && pn.test(e) && (r = a.width, i = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = r, a.minWidth = i, a.maxWidth = s), void 0 === o ? o : o + ""
    }) : dn.currentStyle && (mn = function (t) {
        return t.currentStyle
    }, gn = function (t, e, n) {
        var r, i, s, o, a = t.style;
        return n = n || mn(t), o = n ? n[e] : void 0, null == o && a && a[e] && (o = a[e]), hn.test(o) && !yn.test(e) && (r = a.left, i = t.runtimeStyle, s = i && i.left, s && (i.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : o, o = a.pixelLeft + "px", a.left = r, s && (i.left = s)), void 0 === o ? o : o + "" || "auto"
    });
    var vn = /alpha\([^)]*\)/i,
        wn = /opacity\s*=\s*([^)]*)/i,
        bn = /^(none|table(?!-c[ea]).+)/,
    ...
    fe.extend({
        ...
        css: function (t, e, n, r) {
            var i, s, o, a = fe.camelCase(e);
            return e = fe.cssProps[a] || (fe.cssProps[a] = E(a) || a), o = fe.cssHooks[e] || fe.cssHooks[a], o && "get" in o && (s = o.get(t, !0, n)), void 0 === s && (s = gn(t, e, r)), "normal" === s && e in kn && (s = kn[e]), "" === n || n ? (i = parseFloat(s), n === !0 || isFinite(i) ? i || 0 : s) : s
        }
    }), fe.each(["height", "width"], function (t, e) {
        fe.cssHooks[e] = {
            get: function (t, n, r) {
                return n ? bn.test(fe.css(t, "display")) && 0 === t.offsetWidth ? fn(t, _n, function () {
                    return F(t, e, r)
                }) : F(t, e, r) : void 0
            },
            set: function (t, n, r) {
        ...
        css: function (t, e) {
            return Ne(this, function (t, e, n) {
                var r, i, s = {},
                    o = 0;
                if (fe.isArray(e)) {
                    for (r = mn(t), i = e.length; i > o; o++) s[e[o]] = fe.css(t, e[o], !1, r);
                    return s
                }
    ...
    fe.extend({
        ...
        ajax: function (e, n) {
            function r(e, n, r, i) {
                var s, p, v, w, S, k = n;
                2 !== b && (b = 2, l && t.clearTimeout(l), u = void 0, a = i || "", _.readyState = e > 0 ? 4 : 0, s = e >= 200 && 300 > e || 304 === e, r && (w = Y(h, _, r)), w = Q(h, w, _, s), s ? (h.ifModified && (S = _.getResponseHeader("Last-Modified"), S && (fe.lastModified[o] = S), S = _.getResponseHeader("etag"), S && (fe.etag[o] = S)), 204 === e || "HEAD" === h.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = w.state, p = w.data, v = w.error, s = !v)) : (v = k, (e || !k) && (k = "error", 0 > e && (e = 0))), _.status = e, _.statusText = (n || k) + "", s ? m.resolveWith(f, [p, k, _]) : m.rejectWith(f, [_, k, v]), _.statusCode(y), y = void 0, c && d.trigger(s ? "ajaxSuccess" : "ajaxError", [_, h, s ? p : v]), g.fireWith(f, [_, k]), c && (d.trigger("ajaxComplete", [_, h]), --fe.active || fe.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(_).complete = g.add, _.success = _.done, _.error = _.fail, h.url = ((e || h.url || er) + "").replace(Bn, "").replace(Gn, nr[1] + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = fe.trim(h.dataType || "*").toLowerCase().match(Je) || [""], null == h.crossDomain && (i = Xn.exec(h.url.toLowerCase()), h.crossDomain = !(!i || i[1] === nr[1] && i[2] === nr[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (nr[3] || ("http:" === nr[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = fe.param(h.data, h.traditional)), W(Kn, h, n, _), 2 === b) return _;
            c = fe.event && h.global, c && 0 === fe.active++ && fe.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Qn.test(h.type), o = h.url, h.hasContent || (h.data && (o = h.url += (Rn.test(o) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = Wn.test(o) ? o.replace(Wn, "$1_=" + zn++) : o + (Rn.test(o) ? "&" : "?") + "_=" + zn++)), h.ifModified && (fe.lastModified[o] && _.setRequestHeader("If-Modified-Since", fe.lastModified[o]), fe.etag[o] && _.setRequestHeader("If-None-Match", fe.etag[o])), (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && _.setRequestHeader("Content-Type", h.contentType), _.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + tr + "; q=0.01" : "") : h.accepts["*"]);
            for (s in h.headers) _.setRequestHeader(s, h.headers[s]);
            if (h.beforeSend && (h.beforeSend.call(f, _, h) === !1 || 2 === b)) return _.abort();
            S = "abort";
            for (s in {
                    success: 1,
                    error: 1,
            ...
            if (u = W(Zn, h, n, _)) {
                if (_.readyState = 1, c && d.trigger("ajaxSend", [_, h]), 2 === b) return _;
    ...
    return fe.noConflict = function (e) {
        return t.$ === fe && (t.$ = mr), e && t.jQuery === fe && (t.jQuery = dr), fe
    }, e || (t.jQuery = t.$ = fe), fe
}), ! function (t) {
...
function () {
            ...
            set: function (t, e) {
                ...
                if (h.length || w)
                    if (u && (l = !0), this.length += h.length, null != c)
                        ...
                        for (var _ = v || h, S = 0; S < _.length; S++) this.models.push(_[S])
                    }
                if (l && this.sort({
                        silent: !0
                    }), !e.silent) {
                    for (var k = null != c ? n.clone(e) : e, S = 0; S < h.length; S++) null != c && (k.index = c + S), (s = h[S]).trigger("add", s, this, k);
    ...
    function (t, e) {
        ...
        return n.each(["set", "remove", "reset"], function (t) {
            _[t] = i.prototype[t], a[t] = function (e) {
                return this.model.prototype instanceof l && this.parents && (arguments[0] = S(this.parents, this, e)), _[t].apply(this, arguments)
            }
        }), _.trigger = a.trigger, a.trigger = function () {
            this._deferEvents ? (this._pendingEvents = this._pendingEvents || [], this._pendingEvents.push({
                c: this,
                a: arguments
        ...
        function s(e) {
            if (i(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                var m = a.paddingLeft + a.paddingRight,
                    ...
                    S = u && o,
                    _ = t(s.width);
                _ !== !1 && (a.width = _ + (S ? 0 : m + w));
                var k = t(s.height);
                return k !== !1 && (a.height = k + (S ? 0 : g + b)), a.innerWidth = a.width - (m + w), a.innerHeight = a.height - (g + b), a.outerWidth = a.width + y, a.outerHeight = a.height + v, a
            }
        }
        ...
        this.JST || (this.JST = {}), this.JST.errors = function () {
            return this.Skim = {
                ...
                function (t) {
                    return null == t && (t = {}), Skim.withContext.call({}, t, function () {
                        var t;
                        return t = "", t += '<ul class="errors source-errors ph-25">', $.each(this.errors, function (e) {
                            return function (n) {
                ...
                function (t) {
                    return null == t && (t = {}), Skim.withContext.call({}, t, function () {
                        ...
                        return t = "", t += "<li", e = "", e += this.escape(this.post.classes()), e.length > 0 && (t += ' class="', t += e, t += '"'), t += ' data-id="', t += this.escape(this.post.get("id")), t += '">', t += Juicer.Helpers.renderPartial("actions", {
                            post: this.post,
                            admin: this.admin
                        }), null != this.post.get("image") ? (t += '<img alt="" alt="', t += this.escape(this.post.alt()), t += '" class="j-content-image" src="', t += this.escape(this.post.get("image")), t += '" />') : (t += '<div class="j-text">', t += Juicer.Helpers.renderPartial("message", {
                            post: this.post,
                            truncate: this.truncate
    ...
    function () {
        ...
        Juicer.Views.CreditCard = function (n) {
            ...
            return e(r, n), r.prototype.initialize = function () {
                return Stripe.setPublishableKey(this.$el.data("stripe-key")), this.$("input").placeholder(), this.attempted = !1, this.$el.card({
                ...
                return t.preventDefault(), this.$("input[type=submit]").attr("disabled", "disabled"), Stripe.createToken(this.card(), this.addTokenToForm)
                ...
                }(this)), this.$el[0].submit()) : (n = "<div class='mb-15 errors bg-blood p-15 tc-white fourteen'>" + e.error.message, r = ". <a class='tc-white tdu' href='/faqs#declined-payments' target='_blank'>Help me.</a>", this.attempted && (n += r), n += "</div>", this.$("input[type=submit]").before(n), this.$("input[type=submit]").removeAttr("disabled"), this.attempted = !0)
    ...
    function () {
        ...
        Juicer.Views.Feed = function (n) {
            ...
            return e(r, n), r.prototype.template = JST.feed, r.prototype.referral = JST["partials/_referral"], r.prototype.loading = JST["partials/_loading"], r.prototype.infinite_scroll = JST.infinite_scroll, r.prototype.youTubeEmbed = JST["partials/_youtube_embed"], r.prototype.vineEmbed = JST["partials/_vine_embed"], r.prototype.vimeoEmbed = JST["partials/_vimeo_embed"], r.prototype.instagramEmbed = JST["partials/_instagram_embed"], r.prototype.twitterEmbed = JST["partials/_twitter_embed"], r.prototype.facebookEmbed = JST["partials/_facebook_embed"], r.prototype.tumblrEmbed = JST["partials/_tumblr_embed"], r.prototype.soundcloudEmbed = JST["partials/_soundcloud_embed"], r.prototype.spotifyEmbed = JST["partials/_spotify_embed"], r.prototype.swfEmbed = JST["partials/_swf_embed"], r.prototype.initialize = function (t) {
                ...
                return t.removeClass("playing"), t.html("<img alt="" src='" + t.data("image") + "' style='width:100%;display:block;' />"), null != this.slider ? this.slider.$el.slick("slickPlay") : void 0
    ...
    }.call(this), Juicer.Constants = {}, Juicer.Constants.API_ROOT = "//www.juicer.io", Juicer.Constants.ASSET_PATH = "//assets.juicer.io", Juicer.Constants.FEED_CLASSES = ["modern", "night", "polaroid", "image-grid", "widget", "slider", "classic", "hip", "living-wall"], Juicer.Constants.BASE_URL = "https://www.juicer.io", Juicer.Constants.PAID_PLANS = ["medium", "large", "custom", "enterprise", "campaign"], Juicer.Constants.CAN_ADD_MANUAL = ["Facebook", "Instagram", "Twitter", "YouTube", "Tumblr", "Vimeo", "Soundcloud"], Juicer.Constants.FACEBOOK_APP_ID = "731223346944897", Juicer.Constants.GOOGLE_MAPS_KEY = "", Juicer.Constants.CACHE_BUSTER = "need to bust the cache for campaign mode", (navigator.userAgent.match(/MSIE 9/) || navigator.userAgent.match(/MSIE 8/) || "file:" === window.location.protocol) && (Juicer.Constants.API_ROOT = "https:" + Juicer.Constants.API_ROOT),
    function () {
        var t = function (t, n) {
                function r() {
                    this.constructor = t
