...
class CreateLabTestsInformationTable extends Migration
{
    ...
    public function up()
    {
        ...
        //Micronutrients
        SKU::create(['name' => 'Micronutrients', 'item_type' => 'product', 'price' => 299])->labTestInformation()->create([
        ...
        //Hormones
        SKU::create(['name' => 'Hormones', 'item_type' => 'product', 'price' => 99])->labTestInformation()->create([
        ...
        //Adrenals
        SKU::create(['name' => 'Adrenals', 'item_type' => 'product', 'price' => 125])->labTestInformation()->create([
        ...
        //Thyroid/Cortisol
        SKU::create(['name' => 'Thyroid/Cortisol', 'item_type' => 'product', 'price' => 99])->labTestInformation()->create([
        ...
        //CardioMetabolic
        SKU::create(['name' => 'CardioMetabolic', 'item_type' => 'product', 'price' => 99])->labTestInformation()->create([
        ...
        //CBC/CMP
        SKU::create(['name' => 'CBC/CMP', 'item_type' => 'product', 'price' => 29])->labTestInformation()->create([
        ...
        //Toxic Metals
        SKU::create(['name' => 'Toxic Metals', 'item_type' => 'product', 'price' => 199])->labTestInformation()->create([
        ...
        //Toxic Chemicals
        SKU::create(['name' => 'Toxic Chemicals', 'item_type' => 'product', 'price' => 199])->labTestInformation()->create([
        ...
        //Food Allergy
        SKU::create(['name' => 'Food Allergy', 'item_type' => 'product', 'price' => 199])->labTestInformation()->create([
        ...
        //Microbiome (Gut)
        SKU::create(['name' => 'Microbiome (Gut)', 'item_type' => 'product', 'price' => 199])->labTestInformation()->create([
        ...
        //Organic Acids
        SKU::create(['name' => 'Organic Acids', 'item_type' => 'product', 'price' => 299])->labTestInformation()->create([
