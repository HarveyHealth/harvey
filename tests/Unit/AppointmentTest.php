...
use App\Models\{Appointment, Patient, Practitioner};
use Carbon\Carbon;
use Tests\TestCase;
...
class AppointmentTest extends TestCase
{
    ...
    public function test_an_appointment_is_not_locked_when_over_4_hours_away()
    {
        $hours_away = Carbon::now()->addHours(6);
        $appointment = factory(Appointment::class)->make([
