...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Errors_js__ = __webpack_require__(41);
...
var Form = function () {
    function Form(data) {
        ...
        this.errors = new __WEBPACK_IMPORTED_MODULE_1__Errors_js__["a" /* default */]();
    }

    _createClass(Form, [{
        key: 'data',
        value: function data() {
            var data = _.assign({}, this);
        ...
        key: 'submit',
        value: function submit(requestType, url, successCallback) {
            axios[requestType](url, this.data()).then(this.onSuccess.bind(this, successCallback)).catch(this.onFail.bind(this));
        }
    }, {
        key: 'onSuccess',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objects_Form_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_TopNav__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_pages_Symptoms_vue__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_pages_Symptoms_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_pages_Symptoms_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_includes_VerticalTab_vue__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_includes_VerticalTab_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_includes_VerticalTab_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_includes_VerticalTabs_vue__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_includes_VerticalTabs_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_includes_VerticalTabs_vue__);
...
var app = new Vue({
    mixins: [__WEBPACK_IMPORTED_MODULE_3__mixins_TopNav__["a" /* default */]],
    components: {
        Symptoms: __WEBPACK_IMPORTED_MODULE_4__components_pages_Symptoms_vue___default.a,
        VerticalTab: __WEBPACK_IMPORTED_MODULE_5__components_includes_VerticalTab_vue___default.a,
        VerticalTabs: __WEBPACK_IMPORTED_MODULE_6__components_includes_VerticalTabs_vue___default.a
    },
    data: {
        guest: true,
        appLoaded: false,
        login: {
            form: new __WEBPACK_IMPORTED_MODULE_2__objects_Form_js__["a" /* default */]({
                email: '',
                password: '',
                remember: false
            })
    ...
    methods: {
        ...
        onSuccess: function onSuccess(redirectUrl) {
        ...
        getStarted: function getStarted() {
            ...
            if (this.symptomsChanged) {
                ...
                var formattedStats = Object.keys(this.symptomsStats).reduce(function (ret, key) {
                    ret[key] = _this.symptomsStats[key].value;
                    return ret;
                }, {});
                try {
        ...
        checkWhichPage: function checkWhichPage() {
            var _this2 = this;
            ...
            result = [].concat(_toConsumableArray(args)).some(function (arg) {
                return _this2.bodyClassNames.contains(arg);
            });
            return result;
        },
        invertNavOnScroll: function invertNavOnScroll(e) {
        ...
        onIframeClick: function onIframeClick() {
            var _this3 = this;

            if (document.activeElement === document.querySelector('iframe')) {
                setTimeout(function () {
                    _this3.showSignupContent = false;
                }, 200);
                setTimeout(function () {
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        updateTab: function updateTab(tabData) {
            this.tabList = _.assign({}, this.tabList, _defineProperty({}, tabData.id, tabData));
        },
    ...
    computed: {
        activeTabNumber: function activeTabNumber() {
            if (this.activeTab) {
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            if (Object.keys(_this.tabList).length && !_this.activeTab) {
                var firstTab = Object.keys(_this.tabList)[0];

                _this.setActiveTab(_this.tabList[firstTab]);
            }
        });
    }
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slider_component__ = __webpack_require__(262);
...
// module
exports.push([module.i, "\n.vertical-tabs[data-v-9364c0a0] {\n  background-color: #fff;\n}\n.tabs-navigation[data-v-9364c0a0] {\n  border-top: 1px solid #e3eaee;\n  border-left: 1px solid #e3eaee;\n}\n.tabs-navigation li[data-v-9364c0a0] {\n    border-right: 1px solid #e3eaee;\n    border-bottom: 1px solid #e3eaee;\n}\n@media screen and (min-width: 768px) {\n.tabs-navigation li[data-v-9364c0a0] {\n        border-right: none;\n}\n}\n.tabs-navigation li a[data-v-9364c0a0]:not(.is-active):hover {\n      background-color: transparent;\n}\n@media screen and (min-width: 768px) {\n.tabs-navigation[data-v-9364c0a0] {\n      border-bottom: 1px solid #e3eaee;\n}\n.tabs-navigation li[data-v-9364c0a0] {\n        border-right: none;\n}\n}\n.menu-label[data-v-9364c0a0] {\n  font-size: 1em;\n  margin-bottom: 0;\n  padding: 0.5em 0.75em;\n  background-color: #f5f8fa;\n  text-transform: initial;\n}\n.tabs-content[data-v-9364c0a0] {\n  border: 1px solid #e3eaee;\n  overflow: hidden;\n}\n@media screen and (max-width: 767px) {\n.tabs-content[data-v-9364c0a0] {\n      border-top: none;\n}\n}\n.columns.is-gapless > .tabs-content.column[data-v-9364c0a0] {\n    padding: 1.5rem 0.75rem;\n}\n@media screen and (min-width: 768px) {\n.columns.is-gapless > .tabs-content.column[data-v-9364c0a0] {\n        padding-top: 3rem;\n        padding-bottom: 3rem;\n}\n}\n", ""]);
...
Component.options.__file = "/Users/ryanbuttrey/Documents/Development/newharvey/harvey/resources/assets/legacy/js/components/_includes/VerticalTab.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] VerticalTab.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f0d7bd3", Component.options)
  } else {
    hotAPI.reload("data-v-2f0d7bd3", Component.options)
  }
})()}
...
Component.options.__file = "/Users/ryanbuttrey/Documents/Development/newharvey/harvey/resources/assets/legacy/js/components/_includes/VerticalTabs.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] VerticalTabs.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9364c0a0", Component.options)
  } else {
    hotAPI.reload("data-v-9364c0a0", Component.options)
  }
})()}
...
Component.options.__file = "/Users/ryanbuttrey/Documents/Development/newharvey/harvey/resources/assets/legacy/js/components/pages/Symptoms.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Symptoms.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c629a3a8", Component.options)
  } else {
    hotAPI.reload("data-v-c629a3a8", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.tabId === _vm.$parent.activeTab),
      expression: "tabId === $parent.activeTab"
    }],
    staticClass: "tab copy-has-max-width",
    attrs: {
      "id": _vm.tabId
    }
  }, [_vm._t("default")], 2)])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2f0d7bd3", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "columns is-gapless vertical-tabs"
  }, [_c('div', {
    staticClass: "column is-3 tabs-navigation"
  }, [_c('aside', {
    staticClass: "menu"
  }, [_c('ul', {
  ...
  }, [_vm._v("Choose a Topic")]), _vm._v(" "), _vm._l((_vm.tabList), function(tabData) {
    return _c('li', [_c('a', {
      class: {
        'is-active': tabData.id === _vm.activeTab
      },
      on: {
        "click": function($event) {
          _vm.setActiveTab(tabData)
        }
      }
    }, [_vm._v(_vm._s(tabData.label))])])
  })], 2)])]), _vm._v(" "), _c('div', {
    staticClass: "column tabs-content"
  }, [_vm._t("default")], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-9364c0a0", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "symptoms-selector-wrapper columns is-desktop is-multiline"
  }, _vm._l((_vm.stats), function(stat) {
    return _c('div', {
      staticClass: "control column is-half-desktop"
    }, [_c('div', {
      staticClass: "control-label"
    }, [_c('label', {
      staticClass: "label"
    }, [_vm._v(_vm._s(stat.label))]), _vm._v(" "), _c('label', {
      staticClass: "symptoms-selector-description"
    }, [_vm._v(_vm._s(stat.description))])]), _vm._v(" "), _c('div', {
      staticClass: "control"
    }, [_c('vue-slider', {
      attrs: {
        "min": _vm.min,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c629a3a8", module.exports)
  }
}
...
var update = __webpack_require__(4)("4cac3fc4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-9364c0a0&scoped=true!../../../../../../node_modules/sass-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./VerticalTabs.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-9364c0a0&scoped=true!../../../../../../node_modules/sass-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./VerticalTabs.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("56f15370", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c629a3a8!../../../../../../node_modules/sass-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Symptoms.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c629a3a8!../../../../../../node_modules/sass-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Symptoms.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return phone; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return hyperlink; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__filters_textformat_js__ = __webpack_require__(33);
