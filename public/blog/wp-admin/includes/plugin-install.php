			...
			<ul class="contributors">
				...
				foreach ( (array) $api->contributors as $contrib_username => $contrib_profile ) {
					...
					if ( empty( $contrib_profile ) ) {
						echo "<li><img alt="" src='https://wordpress.org/grav-redirect.php?user={$contrib_username}&amp;s=36' width='18' height='18' alt='' />{$contrib_username}</li>";
					} else {
						echo "<li><a href='{$contrib_profile}' target='_blank'><img alt="" src='https://wordpress.org/grav-redirect.php?user={$contrib_username}&amp;s=36' width='18' height='18' alt='' />{$contrib_username}</a></li>";
					}
				}
				?>
			</ul>
