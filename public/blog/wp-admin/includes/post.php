...
function _admin_notice_post_locked() {
	...
	if ( $locked ) {
		...
		<div class="post-taken-over">
			...
			<span class="locked-saving hidden"><img alt="" src="<?php echo esc_url( admin_url( 'images/spinner-2x.gif' ) ); ?>" width="16" height="16" alt="" /> <?php _e( 'Saving revision&hellip;' ); ?></span>
