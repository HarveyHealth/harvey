...
if ( ! class_exists( 'CMB2_Bootstrap_2221', false ) ) {
	...
	class CMB2_Bootstrap_2221 {
		...
		public function include_cmb() {
			...
			require_once trailingslashit( get_template_directory() ) . 'inc/CMB2/includes/CMB2.php';
			require_once trailingslashit( get_template_directory() ) . 'inc/CMB2/includes/helper-functions.php';

			// Now kick off the class autoloader
			spl_autoload_register( 'cmb2_autoload_classes' );

			// Kick the whole thing off
			require_once trailingslashit( get_template_directory() ) . 'inc/CMB2/bootstrap.php';
			cmb2_bootstrap();
		}
