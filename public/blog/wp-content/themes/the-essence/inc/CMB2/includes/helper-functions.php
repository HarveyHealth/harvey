...
function cmb2_get_oembed( $args = array() ) {
	...
	$error = sprintf( __( 'No oEmbed Results Found for %s. View more info at %s.', 'the-essence' ), $oembed['fallback'], ' <a href="http://codex.wordpress.org/Embeds" target="_blank">codex.wordpress.org/Embeds</a>' );
...
function cmb2_print_metabox_form( $meta_box, $object_id = 0, $args = array() ) {
	...
	$args = wp_parse_args( $args, array(
		...
		'save_button' => __( 'Save', 'the-essence' ),
