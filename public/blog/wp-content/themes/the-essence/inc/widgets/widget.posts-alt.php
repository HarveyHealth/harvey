...
add_action( 'widgets_init', create_function( '', 'register_widget( "the_essence_posts_list_alt_widget" );' ) );
class The_Essence_Posts_List_Alt_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'the_essence_posts_list_alt_widget', // Base ID
			esc_html__( 'MeridianThemes - Posts Alternate List', 'the-essence' ), // Name
		...
		if ( $the_essence_query->have_posts() ) :
			...
			<div class="posts-list-alt-widget clearfix">
				...
				<?php while ( $the_essence_query->have_posts() ) : $the_essence_query->the_post(); $count++; $real_count++; ?>
					...
					<?php include( locate_template( 'template-parts/listing/blog-post-s7.php' ) ); ?>
