...
// Register Widget
add_action( 'widgets_init', create_function( '', 'register_widget( "the_essence_about_author_widget" );' ) );

// Widget Class
class The_Essence_About_Author_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'the_essence_about_author_widget', // Base ID
			esc_html__( 'MeridianThemes - About Author', 'the-essence' ), // Name
			array( 'description' => esc_html__( 'Show info about the author.', 'the-essence' ) ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'author_image' ) ); ?>"><?php esc_html_e( 'Author Image URL:', 'the-essence' ); ?></label> 
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>"><?php esc_html_e( 'Heading Title:', 'the-essence' ); ?></label> 
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'name' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'name' ) ); ?>" type="text" value="<?php echo esc_attr( $name ); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:', 'the-essence' ); ?></label> 
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'signature_image' ) ); ?>"><?php esc_html_e( 'Signature Image URL:', 'the-essence' ); ?></label> 
