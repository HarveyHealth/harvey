			...
			<?php
				...
				$form_args = array(
					...
					'fields' => array(
						...
						'url' => '<p class="push-down-15"><label for="url">' . esc_html__( 'Website' , 'readable' ) . ( $req ? ' <span class="warning">*</span>' : '' ) . '<input class="form-control  form-control--contact" id="url" name="url" type="text" value="' . esc_attr(  $commenter['comment_author_url'] ) . '" size="30" /></label></p>',
					)
				);
