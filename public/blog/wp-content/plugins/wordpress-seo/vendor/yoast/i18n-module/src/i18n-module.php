	...
	public function promo() {
		...
		if ( $message ) {
			...
			if ( isset( $this->glotpress_logo ) && '' != $this->glotpress_logo ) {
				echo '<a href="' . esc_url( $this->register_url ) . '"><img alt="" class="alignright" style="margin:0 5px 5px 5px;max-width:200px;" src="' . esc_url( $this->glotpress_logo ) . '" alt="' . esc_attr( $this->glotpress_name ) . '"/></a>';
			}
			echo $message;
			echo '</div>';
			echo '</div>';
