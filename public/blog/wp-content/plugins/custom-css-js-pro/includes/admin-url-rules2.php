...
class CustomCSSandJS_URLRules {
    ...
    function get_filters($a = 'type') {
         ...
         */
        if ($a == 'select_data') return $select_data;
    ...
    function get_post_types($type = 'post_types') {
        ...
        if (!is_array($post_types_raw) || count($post_types_raw) == 0 ) return array();
