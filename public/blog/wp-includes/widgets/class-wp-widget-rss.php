...
class WP_Widget_RSS extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title )
			$title = '<a class="rsswidget" href="' . esc_url( $url ) . '"><img alt="" class="rss-widget-icon" style="border:0" width="14" height="14" src="' . esc_url( $icon ) . '" alt="RSS" /></a> <a class="rsswidget" href="' . esc_url( $link ) . '">'. esc_html( $title ) . '</a>';
